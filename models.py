...
class Product(Model):
    ...
    category = fields.CharField(max_length = 25, index = True)
    original_price = fields.DecimalField(max_digits =15, decimal_places = 2)
    new_price = fields.DecimalField(max_digits =15, decimal_places = 2)
